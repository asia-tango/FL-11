const ZERO = 0;
let PRIZE_INCREASE = 2;
let RANDOM_INCREASE = 4;
...
if (!playGame) {
    ...
    do {
        ...
        alert(randomNumber);*/
        do {
            guess = prompt(Choose a roulette pocket from ${minRange} to ${maxRange} +
        ...
        if (guess === randomNum) {
            ...
            continueGame = confirm(Congratulation, you won! Your prize is: ${prizeTotal}$. Do you want to continue?);
